...
local function init ( objects )
	...
	table [ "num_games" ] = 61
	table [ "xp" ] = 3930
	table [ "top_games" ] = objects [ 0x00000063 ]
	table [ "currentSaveSlot" ] = 2
	table [ "name" ] = [==[default]==]
	table [ "num_campaigns" ] = 24
	table [ "saveScumDaySlots" ] = objects [ 0x00000262 ]
	table [ "saveScumLevelSlots" ] = objects [ 0x000002B6 ]
	table [ "storyWins" ] = 1
...
OS: Darwin.14.4.0.Darwin Kernel Version 14.4.0: Thu May 28 11:35:04 PDT 2015; root:xnu-2782.30.5~1/RELEASE_X86_64]==]
	...
	table [ "play_t" ] = 1
	table [ "previousDay" ] = -1
	table [ "uiMemento" ] = objects [ 0x00000048 ]
	table [ "agency" ] = objects [ 0x0000004A ]
	table [ "hours" ] = 0
	table [ "difficultyOptions" ] = objects [ 0x0000005E ]
	table [ "sim_history" ] = [==[local _ = {}
_[1]={}
_[2]={}
_[2][1]=2
...
return _[1]]==]
	...
	table [ "situation" ] = objects [ 0x0000005F ]
	table [ "save_time" ] = 1439143868
	table [ "missionEvents" ] = objects [ 0x00000060 ]
	table [ "campaignEvents" ] = objects [ 0x00000061 ]
	table [ "campaignDifficulty" ] = 2
	...
	table [ "situations" ] = objects [ 0x00000062 ]

	table = objects [ 0x00000048 ]
	table [ "cameraState" ] = objects [ 0x00000049 ]

	table = objects [ 0x00000049 ]
	table [ "targetZ" ] = 0
	table [ "targetX" ] = -360.95086669922
	table [ "orientation" ] = 3
	table [ "targetZoom" ] = 0.4
	table [ "targetY" ] = -310.69183349609

	table = objects [ 0x0000004A ]
	table [ "nextID" ] = 100
	table [ "unitDefs" ] = objects [ 0x0000004B ]
	table [ "blocker" ] = false
	table [ "id" ] = 1
	table [ "unitDefsPotential" ] = objects [ 0x00000050 ]
	table [ "name" ] = [==[]==]
	table [ "alwaysUnlocked" ] = true
	table [ "cpus" ] = 10
	table [ "abilities" ] = objects [ 0x0000005D ]
	table [ "startLocation" ] = 23
	table [ "cash" ] = 500

	table = objects [ 0x0000004B ]
	table [ 1 ]	= objects [ 0x0000004C ]
	table [ 2 ]	= objects [ 0x0000004E ]
	...
	table [ "upgrades" ] = objects [ 0x0000004F ]
	...
	table [ 2 ]	= objects [ 0x00000053 ]
	table [ 3 ]	= objects [ 0x00000055 ]
	table [ 4 ]	= objects [ 0x00000057 ]
	table [ 5 ]	= objects [ 0x00000059 ]
	table [ 6 ]	= objects [ 0x0000005B ]
	...
	table [ "upgrades" ] = objects [ 0x0000005C ]
	...
	table [ 1 ]	= objects [ 0x00000064 ]
	table [ 2 ]	= objects [ 0x000000D5 ]
	table [ 3 ]	= objects [ 0x00000148 ]
	table [ 4 ]	= objects [ 0x0000019E ]
	table [ 5 ]	= objects [ 0x000001E0 ]
	table [ 6 ]	= objects [ 0x00000220 ]
...
OS: Darwin.14.3.0.Darwin Kernel Version 14.3.0: Mon Mar 23 11:59:05 PDT 2015; root:xnu-2782.20.48~5/RELEASE_X86_64]==]
	...
	table [ "foundPrisoner" ] = true
	table [ "previousDay" ] = 2
	table [ "agency" ] = objects [ 0x00000065 ]
	table [ "agentsFound" ] = 2
	table [ "difficultyOptions" ] = objects [ 0x000000D3 ]
	table [ "situations" ] = objects [ 0x000000D4 ]
	...
	table [ "unitDefs" ] = objects [ 0x00000066 ]
	...
	table [ "id" ] = 1
	table [ "guards_kod" ] = 41
	table [ "unitDefsPotential" ] = objects [ 0x000000CD ]
	table [ "name" ] = [==[]==]
	table [ "abilities" ] = objects [ 0x000000D2 ]
	table [ "cpus" ] = 20
	table [ "nextID" ] = 100
	...
	table [ 3 ]	= objects [ 0x0000008B ]
	table [ 4 ]	= objects [ 0x0000009A ]
	table [ 5 ]	= objects [ 0x000000AB ]
	table [ 6 ]	= objects [ 0x000000B9 ]

	table = objects [ 0x00000067 ]
	table [ "id" ] = 1
	table [ "skills" ] = objects [ 0x00000068 ]
	table [ "template" ] = [==[stealth_1]==]
	table [ "upgrades" ] = objects [ 0x0000006D ]

	table = objects [ 0x00000068 ]
	table [ 1 ]	= objects [ 0x00000069 ]
	table [ 2 ]	= objects [ 0x0000006A ]
	table [ 3 ]	= objects [ 0x0000006B ]
	table [ 4 ]	= objects [ 0x0000006C ]
	...
	table [ 3 ]	= objects [ 0x00000074 ]
	table [ 4 ]	= objects [ 0x00000075 ]
	table [ 5 ]	= objects [ 0x00000076 ]

	table = objects [ 0x0000006E ]
	table [ "upgradeParams" ] = objects [ 0x0000006F ]
	table [ "upgradeName" ] = [==[augment_deckard]==]

	table = objects [ 0x0000006F ]
	table [ "traits" ] = objects [ 0x00000070 ]
	...
	table [ "upgradeParams" ] = objects [ 0x00000072 ]
	table [ "upgradeName" ] = [==[augment_predictive_brawling]==]

	table = objects [ 0x00000072 ]
	table [ "traits" ] = objects [ 0x00000073 ]
	...
	table [ "id" ] = 5
	table [ "skills" ] = objects [ 0x0000007A ]
	table [ "template" ] = [==[engineer_2]==]
	table [ "upgrades" ] = objects [ 0x0000007F ]

	table = objects [ 0x0000007A ]
	table [ 1 ]	= objects [ 0x0000007B ]
	table [ 2 ]	= objects [ 0x0000007C ]
	table [ 3 ]	= objects [ 0x0000007D ]
	table [ 4 ]	= objects [ 0x0000007E ]
	...
	table [ 1 ]	= objects [ 0x00000080 ]
	table [ 2 ]	= objects [ 0x00000083 ]
	table [ 3 ]	= objects [ 0x00000086 ]
	table [ 4 ]	= objects [ 0x00000087 ]
	table [ 5 ]	= objects [ 0x00000088 ]
	...
	table [ "upgradeParams" ] = objects [ 0x00000084 ]
	table [ "upgradeName" ] = [==[item_tazer]==]

	table = objects [ 0x00000084 ]
	table [ "traits" ] = objects [ 0x00000085 ]
	...
	table [ "upgrades" ] = objects [ 0x00000091 ]
	...
	table [ 1 ]	= objects [ 0x00000092 ]
	table [ 2 ]	= objects [ 0x00000095 ]
	table [ 3 ]	= objects [ 0x00000096 ]
	table [ 4 ]	= objects [ 0x00000097 ]
	table [ 5 ]	= [==[augmentUpgradeSlot]==]

	table = objects [ 0x00000092 ]
	table [ "upgradeParams" ] = objects [ 0x00000093 ]
	table [ "upgradeName" ] = [==[augment_banks]==]

	table = objects [ 0x00000093 ]
	table [ "traits" ] = objects [ 0x00000094 ]
	...
	table [ "upgradeParams" ] = objects [ 0x00000098 ]
	table [ "upgradeName" ] = [==[item_tazer]==]

	table = objects [ 0x00000098 ]
	table [ "traits" ] = objects [ 0x00000099 ]
	...
	table [ "id" ] = 2
	table [ "skills" ] = objects [ 0x0000009B ]
	table [ "template" ] = [==[sharpshooter_1]==]
	table [ "upgrades" ] = objects [ 0x000000A0 ]
	...
	table [ 2 ]	= objects [ 0x000000A4 ]
	table [ 3 ]	= objects [ 0x000000A7 ]
	table [ 4 ]	= objects [ 0x000000AA ]

	table = objects [ 0x000000A1 ]
	table [ "upgradeParams" ] = objects [ 0x000000A2 ]
	table [ "upgradeName" ] = [==[augment_shalem]==]

	table = objects [ 0x000000A2 ]
	table [ "traits" ] = objects [ 0x000000A3 ]
	...
	table [ "upgradeParams" ] = objects [ 0x000000A8 ]
	table [ "upgradeName" ] = [==[item_dartgun]==]

	table = objects [ 0x000000A8 ]
	table [ "traits" ] = objects [ 0x000000A9 ]
	...
	table [ "id" ] = 107
	table [ "skills" ] = objects [ 0x000000AC ]
	table [ "template" ] = [==[central]==]
	table [ "upgrades" ] = objects [ 0x000000B1 ]

	table = objects [ 0x000000AC ]
	table [ 1 ]	= objects [ 0x000000AD ]
	table [ 2 ]	= objects [ 0x000000AE ]
	table [ 3 ]	= objects [ 0x000000AF ]
	table [ 4 ]	= objects [ 0x000000B0 ]
	...
	table [ "upgradeParams" ] = objects [ 0x000000B6 ]
	table [ "upgradeName" ] = [==[item_tazer]==]

	table = objects [ 0x000000B6 ]
	table [ "traits" ] = objects [ 0x000000B7 ]
	...
	table [ 1 ]	= objects [ 0x000000C0 ]
	table [ 2 ]	= objects [ 0x000000C3 ]
	table [ 3 ]	= objects [ 0x000000C6 ]
	table [ 4 ]	= objects [ 0x000000C9 ]

	table = objects [ 0x000000C0 ]
	table [ "upgradeParams" ] = objects [ 0x000000C1 ]
	table [ "upgradeName" ] = [==[augment_monst3r]==]

	table = objects [ 0x000000C1 ]
	table [ "traits" ] = objects [ 0x000000C2 ]
	...
	table [ "upgradeParams" ] = objects [ 0x000000CA ]
	table [ "upgradeName" ] = [==[augment_torque_injectors]==]

	table = objects [ 0x000000CA ]
	table [ "traits" ] = objects [ 0x000000CB ]
	...
	table [ 1 ]	= objects [ 0x000000CE ]
	table [ 2 ]	= objects [ 0x000000D0 ]
	...
	table [ "id" ] = 3
	table [ "template" ] = [==[engineer_1]==]
	table [ "upgrades" ] = objects [ 0x000000D1 ]
...
OS: Windows (WOW64).6.1.1DB1]==]
	...
	table [ "foundPrisoner" ] = true
	table [ "previousDay" ] = 2
	table [ "agency" ] = objects [ 0x000000D6 ]
	table [ "agentsFound" ] = 2
	table [ "difficultyOptions" ] = objects [ 0x00000146 ]
	table [ "save_time" ] = 1432487183
	table [ "missionCount" ] = 8
	table [ "location" ] = 28
	table [ "creation_time" ] = 1432127160
	table [ "monst3rInject" ] = false
	table [ "situations" ] = objects [ 0x00000147 ]
	table [ "lastEndlessAlert" ] = false
	table [ "missionsPlayedThisDay" ] = 0
	table [ "version" ] = [==[0.17.2]==]
	...
	table [ "unitDefs" ] = objects [ 0x000000D7 ]
	table [ "upgrades" ] = objects [ 0x000000D8 ]
	...
	table [ "missions_completed_2" ] = 2
	table [ "id" ] = 1
	table [ "unitDefsPotential" ] = objects [ 0x000000DC ]
	table [ "name" ] = [==[]==]
	table [ "cpus" ] = 5
	table [ "abilities" ] = objects [ 0x00000145 ]
	...
	table [ 1 ]	= objects [ 0x000000D9 ]

	table = objects [ 0x000000D9 ]
	table [ "upgradeParams" ] = objects [ 0x000000DA ]
	table [ "upgradeName" ] = [==[augment_holocircuit_overloaders]==]

	table = objects [ 0x000000DA ]
	table [ "traits" ] = objects [ 0x000000DB ]
	...
	table [ 1 ]	= objects [ 0x000000DD ]
	table [ 2 ]	= objects [ 0x000000DF ]
	table [ 3 ]	= objects [ 0x000000E1 ]
	table [ 4 ]	= objects [ 0x000000F2 ]
	table [ 5 ]	= objects [ 0x00000105 ]
	table [ 6 ]	= objects [ 0x00000114 ]
	table [ 7 ]	= objects [ 0x0000012A ]
	...
	table [ "template" ] = [==[stealth_1]==]
	table [ "upgrades" ] = objects [ 0x000000E2 ]
	table [ "id" ] = 1
	table [ "skills" ] = objects [ 0x000000ED ]
	table [ "deployID" ] = 1
	table [ "captureTime" ] = 76

	table = objects [ 0x000000E2 ]
	table [ 1 ]	= objects [ 0x000000E3 ]
	table [ 2 ]	= objects [ 0x000000E6 ]
	table [ 3 ]	= objects [ 0x000000E9 ]
	table [ 4 ]	= objects [ 0x000000EA ]

	table = objects [ 0x000000E3 ]
	table [ "upgradeParams" ] = objects [ 0x000000E4 ]
	table [ "upgradeName" ] = [==[augment_deckard]==]

	table = objects [ 0x000000E4 ]
	table [ "traits" ] = objects [ 0x000000E5 ]
	...
	table [ "upgradeParams" ] = objects [ 0x000000E7 ]
	table [ "upgradeName" ] = [==[item_bio_dartgun]==]

	table = objects [ 0x000000E7 ]
	table [ "traits" ] = objects [ 0x000000E8 ]
	...
	table [ "upgradeParams" ] = objects [ 0x000000EB ]
	table [ "upgradeName" ] = [==[augment_net_downlink]==]

	table = objects [ 0x000000EB ]
	table [ "traits" ] = objects [ 0x000000EC ]
	...
	table [ 1 ]	= objects [ 0x000000EE ]
	table [ 2 ]	= objects [ 0x000000EF ]
	table [ 3 ]	= objects [ 0x000000F0 ]
	table [ 4 ]	= objects [ 0x000000F1 ]
	...
	table [ "template" ] = [==[sharpshooter_1]==]
	table [ "upgrades" ] = objects [ 0x000000F3 ]
	table [ "id" ] = 2
	table [ "skills" ] = objects [ 0x00000100 ]
	table [ "deployID" ] = 1
	table [ "captureTime" ] = 76

	table = objects [ 0x000000F3 ]
	table [ 1 ]	= objects [ 0x000000F4 ]
	table [ 2 ]	= objects [ 0x000000F7 ]
	table [ 3 ]	= objects [ 0x000000FA ]
	table [ 4 ]	= objects [ 0x000000FD ]
	table [ 5 ]	= [==[augmentUpgradeSlot]==]

	table = objects [ 0x000000F4 ]
	table [ "upgradeParams" ] = objects [ 0x000000F5 ]
	table [ "upgradeName" ] = [==[augment_shalem]==]

	table = objects [ 0x000000F5 ]
	table [ "traits" ] = objects [ 0x000000F6 ]
	...
	table [ "upgradeParams" ] = objects [ 0x000000F8 ]
	table [ "upgradeName" ] = [==[item_light_rifle_shalem]==]

	table = objects [ 0x000000F8 ]
	table [ "traits" ] = objects [ 0x000000F9 ]
	...
	table [ "upgradeParams" ] = objects [ 0x000000FB ]
	table [ "upgradeName" ] = [==[augment_torque_injectors]==]

	table = objects [ 0x000000FB ]
	table [ "traits" ] = objects [ 0x000000FC ]
	...
	table [ "upgradeParams" ] = objects [ 0x000000FE ]
	table [ "upgradeName" ] = [==[augment_anatomy_analysis]==]

	table = objects [ 0x000000FE ]
	table [ "traits" ] = objects [ 0x000000FF ]
	...
	table [ 1 ]	= objects [ 0x00000101 ]
	table [ 2 ]	= objects [ 0x00000102 ]
	table [ 3 ]	= objects [ 0x00000103 ]
	table [ 4 ]	= objects [ 0x00000104 ]
	...
	table [ "template" ] = [==[stealth_2]==]
	table [ "upgrades" ] = objects [ 0x00000106 ]
	table [ "id" ] = 4
	table [ "skills" ] = objects [ 0x0000010F ]
	table [ "deployID" ] = 1
	table [ "captureTime" ] = 76

	table = objects [ 0x00000106 ]
	table [ 1 ]	= objects [ 0x00000107 ]
	table [ 2 ]	= objects [ 0x0000010A ]
	table [ 3 ]	= objects [ 0x0000010B ]
	table [ 4 ]	= objects [ 0x0000010C ]

	table = objects [ 0x00000107 ]
	table [ "upgradeParams" ] = objects [ 0x00000108 ]
	table [ "upgradeName" ] = [==[augment_banks]==]

	table = objects [ 0x00000108 ]
	table [ "traits" ] = objects [ 0x00000109 ]
	...
	table [ "upgradeParams" ] = objects [ 0x0000010D ]
	table [ "upgradeName" ] = [==[item_tazer_2]==]

	table = objects [ 0x0000010D ]
	table [ "traits" ] = objects [ 0x0000010E ]
	...
	table [ "template" ] = [==[engineer_2]==]
	table [ "upgrades" ] = objects [ 0x00000115 ]
	table [ "id" ] = 5
	table [ "skills" ] = objects [ 0x00000125 ]
	table [ "deployID" ] = 1
	table [ "captureTime" ] = 76

	table = objects [ 0x00000115 ]
	table [ 1 ]	= objects [ 0x00000116 ]
	table [ 2 ]	= objects [ 0x00000119 ]
	table [ 3 ]	= objects [ 0x0000011C ]
	table [ 4 ]	= objects [ 0x0000011F ]
	table [ 5 ]	= objects [ 0x00000122 ]
	table [ 6 ]	= [==[augmentUpgradeSlot]==]
	...
	table [ 1 ]	= objects [ 0x00000126 ]
	table [ 2 ]	= objects [ 0x00000127 ]
	table [ 3 ]	= objects [ 0x00000128 ]
	table [ 4 ]	= objects [ 0x00000129 ]
	...
	table [ "id" ] = 107
	table [ "skills" ] = objects [ 0x00000133 ]
	table [ "captureTime" ] = 76

	table = objects [ 0x0000012B ]
	table [ 1 ]	= objects [ 0x0000012C ]
	table [ 2 ]	= objects [ 0x0000012F ]
	table [ 3 ]	= objects [ 0x00000132 ]

	table = objects [ 0x0000012C ]
	table [ "upgradeParams" ] = objects [ 0x0000012D ]
	table [ "upgradeName" ] = [==[augment_central]==]

	table = objects [ 0x0000012D ]
	table [ "traits" ] = objects [ 0x0000012E ]
	...
	table [ "upgradeParams" ] = objects [ 0x00000130 ]
	table [ "upgradeName" ] = [==[item_tazer]==]

	table = objects [ 0x00000130 ]
	table [ "traits" ] = objects [ 0x00000131 ]
	...
	table [ 1 ]	= objects [ 0x00000134 ]
	table [ 2 ]	= objects [ 0x00000135 ]
	table [ 3 ]	= objects [ 0x00000136 ]
	...
	table [ "id" ] = 99
	table [ "skills" ] = objects [ 0x00000140 ]
	table [ "captureTime" ] = 76

	table = objects [ 0x00000139 ]
	table [ 1 ]	= objects [ 0x0000013A ]
	table [ 2 ]	= objects [ 0x0000013D ]

	table = objects [ 0x0000013A ]
	table [ "upgradeParams" ] = objects [ 0x0000013B ]
	table [ "upgradeName" ] = [==[augment_monst3r]==]

	table = objects [ 0x0000013B ]
	table [ "traits" ] = objects [ 0x0000013C ]
	...
	table [ "upgradeParams" ] = objects [ 0x0000013E ]
	table [ "upgradeName" ] = [==[item_monst3r_gun]==]

	table = objects [ 0x0000013E ]
	table [ "traits" ] = objects [ 0x0000013F ]

	table = objects [ 0x0000013F ]
	table [ "autoEquip" ] = true

	table = objects [ 0x00000140 ]
	table [ 1 ]	= objects [ 0x00000141 ]
	table [ 2 ]	= objects [ 0x00000142 ]
	table [ 3 ]	= objects [ 0x00000143 ]
	table [ 4 ]	= objects [ 0x00000144 ]
...
OS: Darwin.14.3.0.Darwin Kernel Version 14.3.0: Mon Mar 23 11:59:05 PDT 2015; root:xnu-2782.20.48~5/RELEASE_X86_64]==]
	...
	table [ "foundPrisoner" ] = true
	table [ "previousDay" ] = 1
	table [ "agency" ] = objects [ 0x00000149 ]
	table [ "agentsFound" ] = 2
	table [ "difficultyOptions" ] = objects [ 0x00000194 ]
	table [ "hours" ] = 55
	table [ "missionTotal" ] = 13
	...
	table [ "situations" ] = objects [ 0x00000195 ]
	table [ "result" ] = [==[FAILURE]==]

	table = objects [ 0x00000149 ]
	table [ "items_earned" ] = 6
	table [ "unitDefs" ] = objects [ 0x0000014A ]
	table [ "guards_kod" ] = 28
	...
	table [ "id" ] = 1
	table [ "programs_earned" ] = 2
	table [ "upgrades" ] = objects [ 0x0000014B ]
	table [ "unitDefsPotential" ] = objects [ 0x0000014D ]
	table [ "nextID" ] = 100
	table [ "cpus" ] = 20
	table [ "name" ] = [==[]==]
	table [ "abilities" ] = objects [ 0x00000193 ]
	...
	table [ 1 ]	= objects [ 0x0000014E ]
	table [ 2 ]	= objects [ 0x00000150 ]
	table [ 3 ]	= objects [ 0x00000152 ]
	table [ 4 ]	= objects [ 0x00000160 ]
	table [ 5 ]	= objects [ 0x00000171 ]
	table [ 6 ]	= objects [ 0x00000180 ]
	...
	table [ "template" ] = [==[engineer_1]==]
	table [ "upgrades" ] = objects [ 0x00000153 ]
	table [ "id" ] = 3
	...
	table [ 2 ]	= objects [ 0x00000157 ]
	table [ 3 ]	= objects [ 0x00000158 ]

	table = objects [ 0x00000154 ]
	table [ "upgradeParams" ] = objects [ 0x00000155 ]
	table [ "upgradeName" ] = [==[augment_tony]==]

	table = objects [ 0x00000155 ]
	table [ "traits" ] = objects [ 0x00000156 ]
	...
	table [ "id" ] = 4
	table [ "skills" ] = objects [ 0x0000016C ]
	table [ "deployID" ] = 1
	table [ "captureTime" ] = 45
	...
	table [ "upgradeParams" ] = objects [ 0x0000016A ]
	table [ "upgradeName" ] = [==[augment_net_downlink]==]

	table = objects [ 0x0000016A ]
	table [ "traits" ] = objects [ 0x0000016B ]
	...
	table [ 1 ]	= objects [ 0x0000016D ]
	table [ 2 ]	= objects [ 0x0000016E ]
	table [ 3 ]	= objects [ 0x0000016F ]
	...
	table [ "upgrades" ] = objects [ 0x00000172 ]
	table [ "id" ] = 5
	table [ "skills" ] = objects [ 0x0000017B ]
	table [ "deployID" ] = 1
	table [ "captureTime" ] = 45

	table = objects [ 0x00000172 ]
	table [ 1 ]	= objects [ 0x00000173 ]
	table [ 2 ]	= objects [ 0x00000176 ]
	table [ 3 ]	= objects [ 0x00000177 ]
	...
	table [ 2 ]	= objects [ 0x0000017D ]
	table [ 3 ]	= objects [ 0x0000017E ]
	...
	table [ "upgradeParams" ] = objects [ 0x00000186 ]
	table [ "upgradeName" ] = [==[augment_torque_injectors]==]

	table = objects [ 0x00000186 ]
	table [ "traits" ] = objects [ 0x00000187 ]
	...
	table [ 2 ]	= objects [ 0x00000190 ]
	table [ 3 ]	= objects [ 0x00000191 ]
	table [ 4 ]	= objects [ 0x00000192 ]
	...
	table [ 1 ]	= objects [ 0x00000196 ]
	table [ 2 ]	= objects [ 0x00000197 ]
	table [ 3 ]	= objects [ 0x00000198 ]
	table [ 4 ]	= objects [ 0x00000199 ]
...
OS: Darwin.14.3.0.Darwin Kernel Version 14.3.0: Mon Mar 23 11:59:05 PDT 2015; root:xnu-2782.20.48~5/RELEASE_X86_64]==]
	...
	table [ "foundPrisoner" ] = true
	table [ "previousDay" ] = 1
	table [ "agency" ] = objects [ 0x0000019F ]
	table [ "hours" ] = 54
	table [ "difficultyOptions" ] = objects [ 0x000001D6 ]
	table [ "missionCount" ] = 5
	table [ "version" ] = [==[0.17.3]==]
	table [ "situations" ] = objects [ 0x000001D7 ]
	...
	table [ "id" ] = 1
	table [ "missions_completed_3" ] = 0
	table [ "upgrades" ] = objects [ 0x000001A0 ]
	table [ "unitDefsPotential" ] = objects [ 0x000001A2 ]
	table [ "programs_earned" ] = 1
	table [ "name" ] = [==[]==]
	table [ "abilities" ] = objects [ 0x000001D4 ]
	table [ "cpus" ] = 14
	table [ "nextID" ] = 100
	table [ "unitDefs" ] = objects [ 0x000001D5 ]
	table [ "alwaysUnlocked" ] = true
	table [ "cash" ] = 148
	...
	table [ 1 ]	= objects [ 0x000001A3 ]
	table [ 2 ]	= objects [ 0x000001A5 ]
	table [ 3 ]	= objects [ 0x000001A7 ]
	table [ 4 ]	= objects [ 0x000001A9 ]
	table [ 5 ]	= objects [ 0x000001AB ]
	table [ 6 ]	= objects [ 0x000001BC ]
	...
	table [ "template" ] = [==[engineer_2]==]
	table [ "upgrades" ] = objects [ 0x000001AC ]
	table [ "id" ] = 5
	table [ "skills" ] = objects [ 0x000001B7 ]
	table [ "deployID" ] = 1
	table [ "captureTime" ] = 45

	table = objects [ 0x000001AC ]
	table [ 1 ]	= objects [ 0x000001AD ]
	table [ 2 ]	= objects [ 0x000001B0 ]
	table [ 3 ]	= objects [ 0x000001B3 ]
	table [ 4 ]	= objects [ 0x000001B6 ]

	table = objects [ 0x000001AD ]
	table [ "upgradeParams" ] = objects [ 0x000001AE ]
	table [ "upgradeName" ] = [==[augment_international_v1]==]

	table = objects [ 0x000001AE ]
	table [ "traits" ] = objects [ 0x000001AF ]
	...
	table [ "upgradeParams" ] = objects [ 0x000001B1 ]
	table [ "upgradeName" ] = [==[item_tazer]==]

	table = objects [ 0x000001B1 ]
	table [ "traits" ] = objects [ 0x000001B2 ]

	table = objects [ 0x000001B2 ]
	table [ "autoEquip" ] = true

	table = objects [ 0x000001B3 ]
	table [ "upgradeParams" ] = objects [ 0x000001B4 ]
	table [ "upgradeName" ] = [==[augment_net_downlink]==]

	table = objects [ 0x000001B4 ]
	table [ "traits" ] = objects [ 0x000001B5 ]
	...
	table [ "id" ] = 6
	table [ "skills" ] = objects [ 0x000001CF ]
	table [ "deployID" ] = 1
	table [ "captureTime" ] = 45
	...
	table [ "upgradeParams" ] = objects [ 0x000001C2 ]
	table [ "upgradeName" ] = [==[item_power_tazer_nika]==]

	table = objects [ 0x000001C2 ]
	table [ "traits" ] = objects [ 0x000001C3 ]

	table = objects [ 0x000001C3 ]
	table [ "autoEquip" ] = true

	table = objects [ 0x000001C4 ]
	table [ "upgradeParams" ] = objects [ 0x000001C5 ]
	table [ "upgradeName" ] = [==[augment_titanium_rods]==]

	table = objects [ 0x000001C5 ]
	table [ "traits" ] = objects [ 0x000001C6 ]
	...
	table [ "upgradeParams" ] = objects [ 0x000001C9 ]
	table [ "upgradeName" ] = [==[augment_piercing_scanner]==]

	table = objects [ 0x000001C9 ]
	table [ "traits" ] = objects [ 0x000001CA ]
	...
	table [ "upgradeParams" ] = objects [ 0x000001CC ]
	table [ "upgradeName" ] = [==[augment_chameleon_movement]==]

	table = objects [ 0x000001CC ]
	table [ "traits" ] = objects [ 0x000001CD ]
	...
	table [ 1 ]	= objects [ 0x000001D0 ]
	table [ 2 ]	= objects [ 0x000001D1 ]
	table [ 3 ]	= objects [ 0x000001D2 ]
	table [ 4 ]	= objects [ 0x000001D3 ]
	...
	table [ 2 ]	= objects [ 0x000001D9 ]
	table [ 3 ]	= objects [ 0x000001DA ]
	table [ 4 ]	= objects [ 0x000001DB ]
	table [ 5 ]	= objects [ 0x000001DC ]
	table [ 6 ]	= objects [ 0x000001DD ]
	table [ 7 ]	= objects [ 0x000001DE ]
	table [ 8 ]	= objects [ 0x000001DF ]
...
OS: Windows (WOW64).6.1.1DB1]==]
	...
	table [ "foundPrisoner" ] = true
	table [ "previousDay" ] = 1
	table [ "agency" ] = objects [ 0x000001E1 ]
	table [ "hours" ] = 43
	table [ "result" ] = [==[FAILURE]==]
	...
	table [ "version" ] = [==[0.17.2]==]
	table [ "monst3rInject" ] = false
	table [ "situations" ] = objects [ 0x00000219 ]
	table [ "lastEndlessAlert" ] = false
	table [ "missionsPlayedThisDay" ] = 2
	table [ "creation_time" ] = 1431795755
	...
	table [ "missionCount" ] = 4
	table [ "agentsFound" ] = 1
	table [ "difficultyOptions" ] = objects [ 0x0000021F ]
	...
	table [ "missions_completed_3" ] = 0
	table [ "id" ] = 1
	table [ "unitDefs" ] = objects [ 0x000001E2 ]
	table [ "unitDefsPotential" ] = objects [ 0x000001E3 ]
	table [ "abilities" ] = objects [ 0x00000217 ]
	table [ "name" ] = [==[]==]
	table [ "cpus" ] = 15
	table [ "programs_earned" ] = 1
	table [ "upgrades" ] = objects [ 0x00000218 ]
	...
	table [ 4 ]	= objects [ 0x000001EA ]
	table [ 5 ]	= objects [ 0x000001FC ]
	table [ 6 ]	= objects [ 0x00000209 ]
	...
	table [ "template" ] = [==[stealth_1]==]
	table [ "upgrades" ] = objects [ 0x000001EB ]
	table [ "id" ] = 1
	table [ "skills" ] = objects [ 0x000001F7 ]
	table [ "deployID" ] = 1
	table [ "captureTime" ] = 36

	table = objects [ 0x000001EB ]
	table [ 1 ]	= objects [ 0x000001EC ]
	table [ 2 ]	= objects [ 0x000001EF ]
	table [ 3 ]	= objects [ 0x000001F2 ]
	table [ 4 ]	= objects [ 0x000001F5 ]
	table [ 5 ]	= objects [ 0x000001F6 ]

	table = objects [ 0x000001EC ]
	table [ "upgradeParams" ] = objects [ 0x000001ED ]
	table [ "upgradeName" ] = [==[augment_deckard]==]

	table = objects [ 0x000001ED ]
	table [ "traits" ] = objects [ 0x000001EE ]
	...
	table [ "upgradeParams" ] = objects [ 0x000001F0 ]
	table [ "upgradeName" ] = [==[item_tazer]==]

	table = objects [ 0x000001F0 ]
	table [ "traits" ] = objects [ 0x000001F1 ]

	table = objects [ 0x000001F1 ]
	table [ "autoEquip" ] = true

	table = objects [ 0x000001F2 ]
	table [ "upgradeParams" ] = objects [ 0x000001F3 ]
	table [ "upgradeName" ] = [==[augment_predictive_brawling]==]

	table = objects [ 0x000001F3 ]
	table [ "traits" ] = objects [ 0x000001F4 ]
	...
	table [ "id" ] = 4
	table [ "skills" ] = objects [ 0x00000204 ]
	table [ "deployID" ] = 1
	table [ "captureTime" ] = 36
	...
	table [ "upgradeParams" ] = objects [ 0x000001FF ]
	table [ "upgradeName" ] = [==[augment_banks]==]

	table = objects [ 0x000001FF ]
	table [ "traits" ] = objects [ 0x00000200 ]
	...
	table [ "upgradeParams" ] = objects [ 0x00000202 ]
	table [ "upgradeName" ] = [==[item_light_pistol_ammo]==]

	table = objects [ 0x00000202 ]
	table [ "traits" ] = objects [ 0x00000203 ]
	...
	table [ 2 ]	= objects [ 0x00000206 ]
	table [ 3 ]	= objects [ 0x00000207 ]
	table [ 4 ]	= objects [ 0x00000208 ]
	...
	table [ "template" ] = [==[engineer_2]==]
	table [ "upgrades" ] = objects [ 0x0000020A ]
	table [ "id" ] = 5
	table [ "skills" ] = objects [ 0x00000212 ]
	table [ "deployID" ] = 1
	table [ "captureTime" ] = 36

	table = objects [ 0x0000020A ]
	table [ 1 ]	= objects [ 0x0000020B ]
	table [ 2 ]	= objects [ 0x0000020E ]
	table [ 3 ]	= objects [ 0x00000211 ]
	...
	table [ 1 ]	= objects [ 0x00000213 ]
	table [ 2 ]	= objects [ 0x00000214 ]
	table [ 3 ]	= objects [ 0x00000215 ]
	table [ 4 ]	= objects [ 0x00000216 ]
	...
	table [ 1 ]	= objects [ 0x0000021A ]
	table [ 2 ]	= objects [ 0x0000021B ]
	table [ 3 ]	= objects [ 0x0000021C ]
	table [ 4 ]	= objects [ 0x0000021D ]
	table [ 5 ]	= objects [ 0x0000021E ]
...
OS: Windows (WOW64).6.1.1DB1]==]
	...
	table [ "foundPrisoner" ] = true
	table [ "previousDay" ] = 1
	table [ "agency" ] = objects [ 0x00000221 ]
	table [ "hours" ] = 39
	table [ "difficultyOptions" ] = objects [ 0x0000025B ]
	table [ "result" ] = [==[FAILURE]==]
	table [ "missionTotal" ] = 9
	table [ "agentsFound" ] = 1
	table [ "missionCount" ] = 4
	table [ "save_time" ] = 1431998076
	table [ "situations" ] = objects [ 0x0000025C ]
	table [ "lastEndlessAlert" ] = false
	...
	table [ "upgrades" ] = objects [ 0x00000222 ]
	table [ "missions_completed" ] = 3
	table [ "missions_completed_1" ] = 2
	table [ "startLocation" ] = 23
	...
	table [ "programs_earned" ] = 1
	table [ "guards_kod" ] = 20
	table [ "unitDefsPotential" ] = objects [ 0x00000223 ]
	table [ "unitDefs" ] = objects [ 0x00000259 ]
	table [ "name" ] = [==[]==]
	table [ "cpus" ] = 17
	table [ "abilities" ] = objects [ 0x0000025A ]
	table [ "missions_completed_3" ] = 0
	...
	table [ 2 ]	= objects [ 0x00000226 ]
	table [ 3 ]	= objects [ 0x00000228 ]
	table [ 4 ]	= objects [ 0x0000022A ]
	table [ 5 ]	= objects [ 0x0000023A ]
	table [ 6 ]	= objects [ 0x0000024A ]
	...
	table [ "template" ] = [==[stealth_1]==]
	table [ "upgrades" ] = objects [ 0x0000022B ]
	table [ "id" ] = 1
	table [ "skills" ] = objects [ 0x00000235 ]
	table [ "deployID" ] = 1
	table [ "captureTime" ] = 34

	table = objects [ 0x0000022B ]
	table [ 1 ]	= objects [ 0x0000022C ]
	table [ 2 ]	= objects [ 0x0000022F ]
	table [ 3 ]	= objects [ 0x00000232 ]
	...
	table [ "upgradeParams" ] = objects [ 0x00000233 ]
	table [ "upgradeName" ] = [==[item_dartgun]==]

	table = objects [ 0x00000233 ]
	table [ "traits" ] = objects [ 0x00000234 ]
	...
	table [ 2 ]	= objects [ 0x00000237 ]
	table [ 3 ]	= objects [ 0x00000238 ]
	table [ 4 ]	= objects [ 0x00000239 ]
	...
	table [ "id" ] = 2
	table [ "skills" ] = objects [ 0x00000245 ]
	table [ "deployID" ] = 1
	table [ "captureTime" ] = 34
	...
	table [ 1 ]	= objects [ 0x00000246 ]
	table [ 2 ]	= objects [ 0x00000247 ]
	table [ 3 ]	= objects [ 0x00000248 ]
	table [ 4 ]	= objects [ 0x00000249 ]
	...
	table [ 1 ]	= objects [ 0x0000025D ]
	table [ 2 ]	= objects [ 0x0000025E ]
	table [ 3 ]	= objects [ 0x0000025F ]
	table [ 4 ]	= objects [ 0x00000260 ]
	table [ 5 ]	= objects [ 0x00000261 ]
	...
	table [ 1 ]	= objects [ 0x00000263 ]
	table [ 2 ]	= objects [ 0x0000029C ]
...
OS: Darwin.14.3.0.Darwin Kernel Version 14.3.0: Mon Mar 23 11:59:05 PDT 2015; root:xnu-2782.20.48~5/RELEASE_X86_64]==]
	...
	table [ "foundPrisoner" ] = true
	table [ "previousDay" ] = 0
	table [ "agency" ] = objects [ 0x00000264 ]
	table [ "hours" ] = 24
	table [ "difficultyOptions" ] = objects [ 0x00000293 ]
	table [ "missionTotal" ] = 9
	table [ "monst3rInject" ] = false
	table [ "creation_time" ] = 1433721105
	table [ "lastEndlessAlert" ] = false
	table [ "missionsPlayedThisDay" ] = 0
	table [ "situations" ] = objects [ 0x00000294 ]
	table [ "version" ] = [==[0.17.3]==]
	...
	table [ "missions_completed_3" ] = 0
	table [ "nextID" ] = 100
	table [ "unitDefs" ] = objects [ 0x00000265 ]
	table [ "unitDefsPotential" ] = objects [ 0x00000286 ]
	table [ "abilities" ] = objects [ 0x00000291 ]
	table [ "cpus" ] = 20
	table [ "name" ] = [==[]==]
	table [ "programs_earned" ] = 1
	...
	table [ 2 ]	= objects [ 0x0000027A ]

	table = objects [ 0x00000266 ]
	table [ "template" ] = [==[disguise_1]==]
	table [ "upgrades" ] = objects [ 0x00000267 ]
	table [ "id" ] = 8
	table [ "skills" ] = objects [ 0x00000275 ]
	table [ "deployID" ] = 1

	table = objects [ 0x00000267 ]
	table [ 1 ]	= objects [ 0x00000268 ]
	table [ 2 ]	= objects [ 0x0000026B ]
	table [ 3 ]	= objects [ 0x0000026E ]
	table [ 4 ]	= objects [ 0x00000271 ]
	table [ 5 ]	= [==[augmentUpgradeSlot]==]
	table [ 6 ]	= objects [ 0x00000274 ]

	table = objects [ 0x00000268 ]
	table [ "upgradeParams" ] = objects [ 0x00000269 ]
	table [ "upgradeName" ] = [==[augment_prism_2]==]

	table = objects [ 0x00000269 ]
	table [ "traits" ] = objects [ 0x0000026A ]
	...
	table [ "upgradeParams" ] = objects [ 0x0000026C ]
	table [ "upgradeName" ] = [==[item_tazer]==]

	table = objects [ 0x0000026C ]
	table [ "traits" ] = objects [ 0x0000026D ]

	table = objects [ 0x0000026D ]
	table [ "autoEquip" ] = true

	table = objects [ 0x0000026E ]
	table [ "upgradeParams" ] = objects [ 0x0000026F ]
	table [ "upgradeName" ] = [==[augment_torque_injectors]==]

	table = objects [ 0x0000026F ]
	table [ "traits" ] = objects [ 0x00000270 ]
	...
	table [ "upgradeParams" ] = objects [ 0x00000272 ]
	table [ "upgradeName" ] = [==[augment_titanium_rods]==]

	table = objects [ 0x00000272 ]
	table [ "traits" ] = objects [ 0x00000273 ]
	...
	table [ 1 ]	= objects [ 0x00000276 ]
	table [ 2 ]	= objects [ 0x00000277 ]
	table [ 3 ]	= objects [ 0x00000278 ]
	table [ 4 ]	= objects [ 0x00000279 ]
	...
	table [ "id" ] = 4
	table [ "skills" ] = objects [ 0x00000281 ]
	table [ "deployID" ] = 1

	table = objects [ 0x0000027B ]
	table [ 1 ]	= objects [ 0x0000027C ]
	table [ 2 ]	= objects [ 0x0000027F ]
	table [ 3 ]	= objects [ 0x00000280 ]

	table = objects [ 0x0000027C ]
	table [ "upgradeParams" ] = objects [ 0x0000027D ]
	table [ "upgradeName" ] = [==[item_dartgun]==]

	table = objects [ 0x0000027D ]
	table [ "traits" ] = objects [ 0x0000027E ]
	...
	table [ 2 ]	= objects [ 0x00000283 ]
	table [ 3 ]	= objects [ 0x00000284 ]
	table [ 4 ]	= objects [ 0x00000285 ]
	...
	table [ 1 ]	= objects [ 0x00000287 ]
	table [ 2 ]	= objects [ 0x00000289 ]
	table [ 3 ]	= objects [ 0x0000028B ]
	table [ 4 ]	= objects [ 0x0000028D ]
	table [ 5 ]	= objects [ 0x0000028F ]
	...
	table [ 3 ]	= objects [ 0x00000297 ]
	table [ 4 ]	= objects [ 0x00000298 ]
	table [ 5 ]	= objects [ 0x00000299 ]
	table [ 6 ]	= objects [ 0x0000029A ]
...
OS: Darwin.14.4.0.Darwin Kernel Version 14.4.0: Thu May 28 11:35:04 PDT 2015; root:xnu-2782.30.5~1/RELEASE_X86_64]==]
	...
	table [ "play_t" ] = 0
	table [ "previousDay" ] = -1
	table [ "agency" ] = objects [ 0x0000029D ]
	table [ "hours" ] = 0
	table [ "difficultyOptions" ] = objects [ 0x000002B1 ]
	table [ "missionTotal" ] = 1
	table [ "save_time" ] = 1439143826
	table [ "missionEvents" ] = objects [ 0x000002B2 ]
	table [ "situations" ] = objects [ 0x000002B3 ]
	table [ "missionCount" ] = 0
	table [ "creation_time" ] = 1439143826
	table [ "version" ] = [==[0.17.6]==]
	table [ "seed" ] = 2633456128
	...
	table [ "location" ] = 23
	table [ "missionsPlayedThisDay" ] = 0
	table [ "campaignEvents" ] = objects [ 0x000002B5 ]

	table = objects [ 0x0000029D ]
	table [ "nextID" ] = 100
	table [ "unitDefs" ] = objects [ 0x0000029E ]
	table [ "blocker" ] = false
	table [ "id" ] = 1
	table [ "unitDefsPotential" ] = objects [ 0x000002A3 ]
	table [ "name" ] = [==[]==]
	table [ "cpus" ] = 10
	table [ "startLocation" ] = 23
	table [ "abilities" ] = objects [ 0x000002B0 ]
	table [ "alwaysUnlocked" ] = true
	table [ "cash" ] = 500

	table = objects [ 0x0000029E ]
	table [ 1 ]	= objects [ 0x0000029F ]
	...
	table [ "id" ] = 3
	table [ "template" ] = [==[engineer_1_a]==]
	table [ "upgrades" ] = objects [ 0x000002A2 ]
	...
	table [ 2 ]	= objects [ 0x000002A6 ]
	table [ 3 ]	= objects [ 0x000002A8 ]
	table [ 4 ]	= objects [ 0x000002AA ]
	table [ 5 ]	= objects [ 0x000002AC ]
	table [ 6 ]	= objects [ 0x000002AE ]
	...
	table [ "id" ] = 7
	table [ "template" ] = [==[cyborg_1]==]
	table [ "upgrades" ] = objects [ 0x000002AF ]
...
OS: Darwin.14.3.0.Darwin Kernel Version 14.3.0: Mon Mar 23 11:59:05 PDT 2015; root:xnu-2782.20.48~5/RELEASE_X86_64]==]
	...
	table [ "agentsFound" ] = 1
	table [ "difficultyOptions" ] = objects [ 0x000002F1 ]
	table [ "hours" ] = 47
	table [ "missionVersion" ] = [==[0.17.3]==]
	table [ "missionTotal" ] = 9
	table [ "preMissionNetWorth" ] = 14247
	table [ "situation" ] = objects [ 0x000002F2 ]
	...
	table [ "missionsPlayedThisDay" ] = 2
	table [ "campaignDifficulty" ] = 2
	table [ "situations" ] = objects [ 0x000002F3 ]
	table [ "monst3rInject" ] = false
	table [ "missionCount" ] = 4
	...
	table [ "missions_completed_3" ] = 1
	table [ "nextID" ] = 100
	table [ "unitDefs" ] = objects [ 0x000002B9 ]
	table [ "unitDefsPotential" ] = objects [ 0x000002DB ]
	table [ "programs_earned" ] = 2
	table [ "abilities" ] = objects [ 0x000002EE ]
	table [ "cpus" ] = 15
	table [ "name" ] = [==[]==]
	table [ "id" ] = 1
	table [ "upgrades" ] = objects [ 0x000002EF ]
	table [ "alwaysUnlocked" ] = true
	table [ "cash" ] = 2647
	...
	table [ 3 ]	= objects [ 0x000002C2 ]
	table [ 4 ]	= objects [ 0x000002C5 ]
	table [ 5 ]	= objects [ 0x000002C8 ]
	table [ 6 ]	= objects [ 0x000002C9 ]
	table [ 7 ]	= [==[augmentUpgradeSlot]==]
	...
	table [ "upgradeParams" ] = objects [ 0x000002C6 ]
	table [ "upgradeName" ] = [==[augment_titanium_rods]==]

	table = objects [ 0x000002C6 ]
	table [ "traits" ] = objects [ 0x000002C7 ]
	...
	table [ "template" ] = [==[stealth_2_a]==]
	table [ "upgrades" ] = objects [ 0x000002D0 ]
	table [ "id" ] = 4
	table [ "skills" ] = objects [ 0x000002D6 ]
	table [ "deployID" ] = 1

	table = objects [ 0x000002D0 ]
	table [ 1 ]	= objects [ 0x000002D1 ]
	table [ 2 ]	= objects [ 0x000002D4 ]
	table [ 3 ]	= objects [ 0x000002D5 ]

	table = objects [ 0x000002D1 ]
	table [ "upgradeParams" ] = objects [ 0x000002D2 ]
	table [ "upgradeName" ] = [==[item_dartgun]==]

	table = objects [ 0x000002D2 ]
	table [ "traits" ] = objects [ 0x000002D3 ]
	...
	table [ 1 ]	= objects [ 0x000002D7 ]
	table [ 2 ]	= objects [ 0x000002D8 ]
	table [ 3 ]	= objects [ 0x000002D9 ]
	table [ 4 ]	= objects [ 0x000002DA ]
	...
	table [ 1 ]	= objects [ 0x000002DC ]
	table [ 2 ]	= objects [ 0x000002DE ]
	table [ 3 ]	= objects [ 0x000002E0 ]
	table [ 4 ]	= objects [ 0x000002E2 ]
	table [ 5 ]	= objects [ 0x000002E4 ]
	...
	table [ "id" ] = 2
	table [ "skills" ] = objects [ 0x000002E5 ]
	table [ "template" ] = [==[sharpshooter_1]==]
	table [ "upgrades" ] = objects [ 0x000002EA ]

	table = objects [ 0x000002E5 ]
	table [ 1 ]	= objects [ 0x000002E6 ]
	...
	table [ 1 ]	= objects [ 0x000002EB ]

	table = objects [ 0x000002EB ]
	table [ "upgradeParams" ] = objects [ 0x000002EC ]
	table [ "upgradeName" ] = [==[augment_shalem]==]

	table = objects [ 0x000002EC ]
	table [ "traits" ] = objects [ 0x000002ED ]
	...
	table [ 1 ]	= objects [ 0x000002F4 ]
	table [ 2 ]	= objects [ 0x000002F5 ]
	table [ 3 ]	= objects [ 0x000002F6 ]
	table [ 4 ]	= objects [ 0x000002F7 ]
...
OS: Darwin.14.4.0.Darwin Kernel Version 14.4.0: Thu May 28 11:35:04 PDT 2015; root:xnu-2782.30.5~1/RELEASE_X86_64]==]
	...
	table [ "preMissionNetWorth" ] = 4600
	table [ "previousDay" ] = -1
	table [ "agency" ] = objects [ 0x000002F9 ]
	table [ "hours" ] = 0
	table [ "difficultyOptions" ] = objects [ 0x0000030D ]
	table [ "missionVersion" ] = [==[0.17.6]==]
	table [ "missionTotal" ] = 1
	table [ "situations" ] = objects [ 0x0000030E ]
	table [ "missionCount" ] = 0
	table [ "situation" ] = objects [ 0x0000030F ]
	table [ "missionEvents" ] = objects [ 0x00000310 ]
	table [ "creation_time" ] = 1439143826
	table [ "location" ] = 23
	table [ "missionsPlayedThisDay" ] = 0
	table [ "version" ] = [==[0.17.6]==]
	table [ "seed" ] = 2633456128
	table [ "campaignDifficulty" ] = 2
	table [ "campaignEvents" ] = objects [ 0x00000311 ]
	table [ "play_t" ] = 0
	table [ "save_time" ] = 1439143829

	table = objects [ 0x000002F9 ]
	table [ "nextID" ] = 100
	table [ "unitDefs" ] = objects [ 0x000002FA ]
	table [ "blocker" ] = false
	table [ "id" ] = 1
	table [ "unitDefsPotential" ] = objects [ 0x000002FF ]
	table [ "name" ] = [==[]==]
	table [ "cpus" ] = 10
	table [ "startLocation" ] = 23
	table [ "abilities" ] = objects [ 0x0000030C ]
	table [ "alwaysUnlocked" ] = true
	table [ "cash" ] = 500

	table = objects [ 0x000002FA ]
	table [ 1 ]	= objects [ 0x000002FB ]
	table [ 2 ]	= objects [ 0x000002FD ]
	...
	table [ 1 ]	= objects [ 0x00000300 ]
	table [ 2 ]	= objects [ 0x00000302 ]
	table [ 3 ]	= objects [ 0x00000304 ]
	table [ 4 ]	= objects [ 0x00000306 ]
	table [ 5 ]	= objects [ 0x00000308 ]
	table [ 6 ]	= objects [ 0x0000030A ]
